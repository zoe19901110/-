...
export default function App() {
  ...
  React.useEffect(() => {
    ...
    setProjects([
      { id: '1', name: `${enterprisePrefix}2024年智慧交通管理平台建设项目`, code: 'ZB-2024-001', tenderer: 'XX市交通运输局', tendererContact: '张工 010-88888888', agent: 'XX招标代理有限公司', agentContact: '李经理 010-66666666', bidOpeningTime: '2024-05-20 10:00', status: '进行中', deposit: '¥50,000', depositDeadline: '2024-05-15 17:00', openingLocation: 'XX市公共资源交易中心 301 会议室', collectionTime: '2024-04-15', requirements: '关键招标要求、资质要求等...', otherRemarks: '' },
      { id: '2', name: `${enterprisePrefix}政务云扩容采购项目`, code: 'ZB-2024-005', tenderer: 'XX市大数据局', tendererContact: '王工 010-77777777', agent: 'YY咨询管理公司', agentContact: '赵经理 010-55555555', bidOpeningTime: '2024-06-15 14:30', status: '已完成', deposit: '¥30,000', depositDeadline: '2024-06-10 17:00', openingLocation: 'XX省政务中心 2楼', collectionTime: '2024-05-10', requirements: '政务云相关资质要求...', otherRemarks: '' },
      { id: '3', name: `${enterprisePrefix}城市绿化带自动灌溉系统`, code: 'ZB-2024-008', tenderer: 'XX市园林局', tendererContact: '刘工 010-99999999', agent: 'ZZ工程咨询公司', agentContact: '孙经理 010-44444444', bidOpeningTime: '2024-07-10 09:00', status: '进行中', deposit: '¥20,000', depositDeadline: '2024-07-05 17:00', openingLocation: 'XX市园林局 5楼会议室', collectionTime: '2024-06-01', requirements: '自动化灌溉系统技术指标...', otherRemarks: '' },
      { id: '4', name: `${enterprisePrefix}XX区智慧教育云平台二期`, code: 'ZB-2024-012', tenderer: 'XX区教育局', tendererContact: '陈工 010-11111111', agent: 'AA招标代理公司', agentContact: '周经理 010-22222222', bidOpeningTime: '2024-08-05 15:00', status: '进行中', deposit: '¥80,000', depositDeadline: '2024-08-01 17:00', openingLocation: 'XX区教育局 1楼大厅', collectionTime: '2024-07-01', requirements: '教育云平台二期扩容需求...', otherRemarks: '' },
      { id: '5', name: `${enterprisePrefix}社区养老服务中心智能化改造`, code: 'ZB-2024-015', tenderer: 'XX市民政局', tendererContact: '黄工 010-33333333', agent: 'BB项目管理公司', agentContact: '吴经理 010-44444444', bidOpeningTime: '2024-09-25 10:30', status: '进行中', deposit: '¥15,000', depositDeadline: '2024-09-20 17:00', openingLocation: 'XX市民政局 3楼', collectionTime: '2024-08-15', requirements: '适老化智能设备安装调试...', otherRemarks: '' },
      { id: '6', name: `${enterprisePrefix}XX市城市道路照明节能改造`, code: 'ZB-2024-020', tenderer: 'XX市城管局', tendererContact: '赵工 010-22223333', agent: 'CC招标代理公司', agentContact: '钱经理 010-11112222', bidOpeningTime: '2024-10-15 09:00', status: '进行中', deposit: '¥40,000', depositDeadline: '2024-10-10 17:00', openingLocation: 'XX市城管局会议室', collectionTime: '2024-09-01', requirements: 'LED节能灯具更换...', otherRemarks: '' },
      { id: '7', name: `${enterprisePrefix}XX区公共图书馆数字化升级`, code: 'ZB-2024-025', tenderer: 'XX区文广旅局', tendererContact: '孙工 010-55556666', agent: 'DD咨询管理公司', agentContact: '李经理 010-77778888', bidOpeningTime: '2024-11-20 14:00', status: '进行中', deposit: '¥25,000', depositDeadline: '2024-11-15 17:00', openingLocation: 'XX区图书馆', collectionTime: '2024-10-01', requirements: '数字化阅读系统...', otherRemarks: '' },
      { id: '8', name: `${enterprisePrefix}XX市污水处理厂扩容工程`, code: 'ZB-2024-030', tenderer: 'XX市水务局', tendererContact: '周工 010-33334444', agent: 'EE工程管理公司', agentContact: '郑经理 010-55556666', bidOpeningTime: '2024-12-05 09:30', status: '进行中', deposit: '¥60,000', depositDeadline: '2024-12-01 17:00', openingLocation: 'XX市水务局会议室', collectionTime: '2024-11-01', requirements: '污水处理设备...', otherRemarks: '' }
    ]);
  }, [currentEnterprise]);
